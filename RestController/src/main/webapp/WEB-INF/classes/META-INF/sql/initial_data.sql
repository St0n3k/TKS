...
INSERT INTO users (version, type, username, first_name, last_name, personal_id, city, street, house_number, active, role, password) VALUES (0, 'Client', 'client', 'Mariusz', 'Pudzianowski', '54352353', 'Warszawa', 'Stalowa', 16, true, 'CLIENT', 'password');
...
INSERT INTO users (version, type, username, first_name, last_name, personal_id, city, street, house_number, active, role, password) VALUES (0, 'Client', 'jakub2', 'Jakub', 'Bukaj', '3584873', 'Krakow', 'Smutna', 13, true, 'CLIENT', 'password');
INSERT INTO users (version, type, username, first_name, last_name, personal_id, city, street, house_number, active, role, password) VALUES (0, 'Client', 'jakub3', 'Kuba', 'Bokaj', '3584173', 'Krakow', 'Smutna', 13, false, 'CLIENT', 'password');
